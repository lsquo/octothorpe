...
2. Type Octothorpe in the search form and press Enter

You can then go ahead and activate the theme.
...
* Let translators disable fonts

= 1.1.0 =
* Add a caption to featured images
* Fix microdata
* Add gallery styles
